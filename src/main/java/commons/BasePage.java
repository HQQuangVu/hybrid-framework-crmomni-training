...
public class BasePage {
	...
	protected void submitElement(WebDriver driver, String locatorType) {
		getWebElement(driver, locatorType).submit();
	}
	...
	protected void setElementVisibilityToVisibleByJS(WebDriver driver, String locatorType) {
		JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;
		jsExecutor.executeScript("arguments[0].setAttribute('style','visibility:visible;');", getWebElement(driver, locatorType));
	}
	...
	public CrmLoginPageObject openCrmLoginPage(WebDriver driver) {
		openPageUrl(driver, GlobalConstants.CRM_PAGE_PORTAL_URL);
		return CrmPageGeneratorManager.getLoginPage(driver);
	}

	public FacebookHomePageObject openFacebookTestPage(WebDriver driver) {
		openPageUrl(driver, GlobalConstants.FACEBOOK_TEST_PAGE_URL);
		return FacebookPageGeneratorManager.getHomePage(driver);
	}
